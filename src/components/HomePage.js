                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center">
                        <div>
                            <div className="max-w-md mx-auto" data-aos="zoom-out-right">
                                <div className={"flex items-center flex-col gap-5 sm:items-start"}>
                                    <h1 className={"uppercase text-blue-800 dark:text-blue-600 font-extrabold text-3xl"}>CodeCrafter</h1>
                                    <p className={"opacity-80 text-xl"}>
                                        CodeCrafter could offer a wide range of learning resources such as tutorials, articles, and interactive coding exercises covering various programming languages and topics.
                                    </p>
                        ...
                        <div className={"order-1"} data-aos="zoom-in-left">
                            <Image
                                ...
                                src="/images/Home/book.png" alt="banner-header.png"/>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 my-10">
                    <div className="self-center " data-aos="zoom-out-right">
                        ...
                        <p className={"sm:text-lg md:text-xl lg:text-xls"}>
                            These resources can be tailored to suit different levels of expertise, from beginners to advanced learners.
                        </p>
                    </div>
